<figure>
  <img src="docs/structure.png" alt="Структура ПО" style="width:80%">
  <figcaption align="center"><b>Структура программного обеспечения</b>: Блок предсказания характеристик и блок оптимизации</figcaption>
</figure>
...
<figure>
  <img src="docs/is_best_plot.png" alt="Сравнение решений по метрикам LUT и CP" style="width:60%">
  <figcaption align="center"><b>Сравнение решений по метрикам LUT и CP</b>: Сравнение ручного и автоматического назначения операций</figcaption>
</figure>